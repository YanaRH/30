...
from lms.models import Course, Lesson  # Убедитесь, что Course и Lesson импортированы
...
class User(AbstractUser ):
    ...
    # Указываем, что email будет использоваться как имя пользователя
    USERNAME_FIELD = "email"
    REQUIRED_FIELDS = []  # Убедитесь, что здесь указаны другие обязательные поля, если они есть
